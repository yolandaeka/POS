            ...
            @else
                ...
                method PUT -->
                    <div class="form-group row">
                        <label class="col-3 control-label col-form-label">Nama Supplier</label>
                        <div class="col-11">
                    ...
                    <div class="form-group row">
                        <label class="col-3 control-label col-form-label">Kode supplier</label>
                        <div class="col-11">
                            <input type="text" class="form-control" id="supplier_kode" name="supplier_kode" value="{{
                            old('supplier_kode', $supplier->supplier_kode) }}" required>
                            @error('supplier_kode')
                            <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        <label class="col-3 control-label col-form-label">Alamat Supplier</label>
                        <div class="col-11">
